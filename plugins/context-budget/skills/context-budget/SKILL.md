...
|-------------------------------|--------------------|--------------------|------------------|
| `CLAUDE.md`                   | <25 non-blank lines | <50 non-blank lines | Trim per Phase 4 of `/clik`. |
...
- Hooks contribute to context only if they print to stdout. clik's hooks are silent on success by design.
